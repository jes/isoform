...
const ui = {
    ...
    buildModifierOptions(contextMenu, node) {
        ...
        const modifiers = [
            ...
            { name: 'Color By Normal', constructor: ColorByNormalNode, icon: ColorByNormalNode.prototype.getIcon() },
            { name: 'Consolidate', constructor: ConsolidateNode, icon: ConsolidateNode.prototype.getIcon() },
        ];
